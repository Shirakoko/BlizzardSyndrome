...
<<<<<<< HEAD
        ...
        //     }
        //     // 如果NPC到达终点，要停下走路动画
        //     if(transform.position==new Vector3(99,0,-21)&&talkCount==1)
        //     {
        //         isMoved = false;
        //         isIdle = true;
        //         animController.Play("idle");
        ...
        //         GameManager.Instance.mCurrentScene.ShowPanelDialog(); // 显示对话面板
        //     }
        //     else if(transform.position==new Vector3(65,0,-16)) // 到达第二个位置后消失
        //     {
...
>>>>>>> 90c4bc3 (1208)
    {
        ...
        {
            StartCoroutine(MoveAndSleep());
            isMoved = true;
        }
    }

    private IEnumerator MoveAndSleep()
    {
        moveAnim.SetTrigger("MoveAround");
        animController.Play("jump");
        yield return new WaitForSeconds(28f); // 来回踱步28秒之后坐着睡觉
        // moveAnim.SetTrigger("Sleep");
        animController.Play("sit");
    }
}
